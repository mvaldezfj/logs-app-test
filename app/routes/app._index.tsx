...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  try {
    ...
    const client = await admin.rest.resources.Shop.all({session});
    ...
    return { events: null, pagination: null };
  }
};
...
export default function IndexPage() {
  ...
  if (!events) return <div>No events in your shop</div>;
  return (
    <div>
      <React.Suspense
...
function Events() {
  ...
  if (!pagination || !events) return <div>No events in your shop</div>;
        ...
        <Card>
          <BlockStack gap="1000">
            ...
            <InlineStack align="start" blockAlign="center" gap="1000">
              ...
              />
              <Text as="h4">Page {pagination.page}</Text>
            </InlineStack>
          </BlockStack>
        </Card>
      </Layout.Section>
